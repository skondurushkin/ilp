...
export function RulesPage(): ReactElement {
    return (
        <div className="text">
            ...
            <h4 className="dark:text-gray mt-4">1. Общие положения</h4>
            <p>
            ...
            <h4 className="dark:text-gray mt-4">2. Условия участия</h4>
            ...
            <h4 className="dark:text-gray mt-4">3. Принципы начисления бонусов</h4>
            <p>
            ...
            <h4 className="dark:text-gray mt-4">4. Вывод бонусов</h4>
            <p>4.1. Бонусы могут быть выведены на карты, указанные сотрудники в своем личном кабинете на портале.</p>
            <p>4.2. Вывод бонусов производится ежемесячно.</p>
            <p>4.3. Обмена бонусов на денежные средства не предусмотрено.</p>

            <h4 className="dark:text-gray mt-4">5. Ответственность</h4>
            <p>
                5.1. Сотрудник несет ответственность за достоверность предоставленной информации о себе при регистрации
                на портале.
            </p>
            <p>
