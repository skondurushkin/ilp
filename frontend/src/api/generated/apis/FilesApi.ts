...
export class FilesApi extends runtime.BaseAPI {
    ...
    async downloadFileRaw(requestParameters: DownloadFileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters.link === null || requestParameters.link === undefined) {
            throw new runtime.RequiredError('link','Required parameter requestParameters.link was null or undefined when calling downloadFile.');
        }
    ...
    async uploadFileRaw(requestParameters: UploadFileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UploadFile200Response>> {
        if (requestParameters.scope === null || requestParameters.scope === undefined) {
            throw new runtime.RequiredError('scope','Required parameter requestParameters.scope was null or undefined when calling uploadFile.');
        }
        ...
        const response = await this.request({
            path: `/api/ilp/file/upload/{scope}`.replace(`{${"scope"}}`, encodeURIComponent(String(requestParameters.scope))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: formParams,
