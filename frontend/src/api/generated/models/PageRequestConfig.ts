...
export function PageRequestConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageRequestConfig {
    ...
    return {
        ...
        'filter': !exists(json, 'filter') ? undefined : ((json['filter'] as Array<any>).map(PageRequestConfigFilterInnerFromJSON)),
    };
}
...
export function PageRequestConfigToJSON(value?: PageRequestConfig | null): any {
    ...
    return {
        ...
        'filter': value.filter === undefined ? undefined : ((value.filter as Array<any>).map(PageRequestConfigFilterInnerToJSON)),
    };
}
